...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, verbose_name='ID', serialize=False)),
                ('avata', models.ImageField(default='', upload_to='avata', max_length=255)),
                ('follows', models.ManyToManyField(related_name='following', through='user.Follow', to='user.UserProfile')),
