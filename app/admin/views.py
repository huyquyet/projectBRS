...
from app.admin.forms import BookCreateFormView
    ...
    def get(self, request, *args, **kwargs):
        ...
        if search:
            ...
            self.queryset = Book.objects.filter(
                Q(title__icontains=search_1) | Q(category__name__icontains=search_1) | Q(
                    author__icontains=search_1) | Q(publish__icontains=search_1))
        else:
...
class AdminDetailRequestBook(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        ctx['detail_request'].full_name = ctx['detail_request'].user_profile.user.first_name + ' ' + ctx[
            'detail_request'].user_profile.user.last_name
